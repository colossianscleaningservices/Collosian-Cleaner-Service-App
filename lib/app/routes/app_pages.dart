...
import '../modules/cleaner/job/job_check_photo_view.dart';
...
class AppPages {
  ...
  static final routes = <GetPage>[
    ...
    GetPage(
      name: _Paths.CLEANER_JOB_CHECKIN,
      page: () => const JobCheckPhotoView(),
      binding: JobCheckPhotoBinding(),
    ),
    GetPage(
      name: _Paths.CLEANER_JOB_CHECKOUT,
      page: () => const JobCheckPhotoView(),
      binding: JobCheckPhotoBinding(),
    ),
    GetPage(
