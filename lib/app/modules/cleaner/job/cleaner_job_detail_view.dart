                        ...
                        AppCard(
                          child: Column(
                            ...
                            children: [
                              ...
                              if (j?.property?.animalProperty != null) LabelValueRow(label: 'Animals', value: j?.property?.animalProperty == "1" ? "Yes" : "No", scheme: scheme),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                runSpacing: 8,
                                children: [
                                  InfoChip(label: cleanerStatus ?? j?.status ?? "N/A", backgroundColor: getBgColor(cleanerStatus ?? j?.status ??"", scheme), foregroundColor: getFgColor(cleanerStatus ?? j?.status ?? "", scheme)),
                                  if (j?.scheduler?.frequency != null)
                                    InfoChip(label: j?.scheduler?.frequency?.capitalizeFirst ?? "", backgroundColor: scheme.tertiaryContainer, foregroundColor: scheme.tertiary),
                                ],
                              ),
                              const SizedBox(height: 12),
