...
class GetClientJobDetailsResponse {
  ...
  GetClientJobDetailsResponse.fromJson(dynamic json) {
    message = json['message'];
    version = json['version'];
    code = json['code'];
    data = json['data'] != null ? ClientJobDetails.fromJson(json['data']) : null;
  }
...
class ClientJobDetails {
  ...
  ClientJobDetails.fromJson(dynamic json) {
    id = json['id'];
    date = json['date'];
